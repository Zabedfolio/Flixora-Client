    ...
    <section className="relative bg-black py-16 px-4 md:px-8 select-none overflow-hidden z-10 border-t border-[#121212]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="group relative w-full rounded-2xl overflow-hidden border border-[#FF4C00]/30 hover:border-[#FF4C00] shadow-[0_0_15px_rgba(255,76,0,0.05)] hover:shadow-[0_0_20px_rgba(255,76,0,0.18)] transition-all duration-500 aspect-[4/5] xs:aspect-video lg:aspect-[2/3] max-h-[460px] lg:max-h-none">
            ...
            <div className="absolute bottom-0 inset-x-0 p-5 sm:p-6 z-20 flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-[#FF4C00] gap-3 mt-3">
                ...
                <button className="w-10 h-10 flex items-center justify-center bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg transition-colors border border-zinc-800 cursor-pointer">
                  <Plus size={16} />
                </button>
              </div>
            </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-4 group/row relative w-full overflow-hidden">
          <button
            onClick={() => scroll('left')}
            className="absolute -left-2 top-1/2 -translate-y-1/2 z-30 w-10 h-10 flex items-center justify-center bg-black/80 hover:bg-[#FF4C00] text-white rounded-full border border-zinc-800 hover:border-transparent opacity-0 group-hover/row:opacity-100 transition-all duration-300 hover:scale-105 cursor-pointer"
          ...
          <button
            ...
            className="absolute -right-2 top-1/2 -translate-y-1/2 z-30 w-10 h-10 flex items-center justify-center bg-black/80 hover:bg-[#FF4C00] text-white rounded-full border border-zinc-800 hover:border-transparent opacity-0 group-hover/row:opacity-100 transition-all duration-300 hover:scale-105 cursor-pointer"

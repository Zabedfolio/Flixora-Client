  ...
  return (
    <section className="relative bg-black py-16 px-4 md:px-8 select-none overflow-hidden z-10 border-t border-[#121212]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto group/row">
        <button
          onClick={() => scroll('left')}
          className="absolute -left-2 top-[38%] -translate-y-1/2 z-30 w-10 h-10 flex items-center justify-center bg-black/80 hover:bg-[#FF4C00] text-white rounded-full border border-zinc-800 hover:border-transparent opacity-0 group-hover/row:opacity-100 transition-all duration-300 hover:scale-105"
        ...
        <button
          ...
          className="absolute -right-2 top-[38%] -translate-y-1/2 z-30 w-10 h-10 flex items-center justify-center bg-black/80 hover:bg-[#FF4C00] text-white rounded-full border border-zinc-800 hover:border-transparent opacity-0 group-hover/row:opacity-100 transition-all duration-300 hover:scale-105"

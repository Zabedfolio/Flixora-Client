      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            {/* Badge row: original streaming badge + new AI Match badge */}
            <motion.div
              initial={{
                opacity: 0,
                y: 30,
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1.5 backdrop-blur-md sm:px-5 sm:py-2">
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-[#FF4C00]/40 bg-[#FF4C00]/10 px-3 py-1.5 backdrop-blur-md sm:px-4 sm:py-2"
                >
                  <Sparkles className="h-3.5 w-3.5 text-[#FF4C00] sm:h-4 sm:w-4" />
                  <span className="text-[8px] font-black tracking-wider text-[#FF4C00] sm:text-[10px] sm:tracking-widest">
                    {matchLabel}
                  </span>
                </motion.div>
              </AnimatePresence>
            ...
            <motion.h1
              ...
              className="mb-6 text-4xl font-black leading-none tracking-tight text-white sm:text-2xl lg:text-4xl"
            >
              {currentMovie.title}
            </motion.h1>
            ...
            <motion.p
              ...
              className="mb-8 max-w-lg text-base leading-relaxed text-zinc-300 sm:text-xs"
            >
            ...
            >
              <Link
                href="/movies"
                className="inline-flex items-center gap-2.5 rounded-xl bg-[#FF4C00] px-8 py-3.5 text-xs font-bold text-white shadow-xl shadow-[#FF4C00]/10 transition-all duration-300 hover:scale-105 hover:bg-[#E04300] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF4C00]"
              >
            ...
            <motion.div
              ...
              className="mt-8 max-w-8/12 mx-auto "
            >
              <form

      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
          <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
            ...
            >
              <img src="/logo.png" alt="Flixora Logo" className="h-14 md:h-16 object-contain" />
            </Link>
            <p className="text-xs text-zinc-500 font-medium">Your stories. Your way.</p>
          </div>
              ...
              <div key={index} className="flex flex-col md:gap-1.5 w-full">
                ...
                <div 
                  className={`md:block transition-all duration-300 overflow-hidden ${
                    isExpanded ? "max-h-[250px] opacity-100 mt-3 pb-4" : "max-h-0 md:max-h-none opacity-0 md:opacity-100 mt-0"
                  }`}
                >
        ...
        <div className="border-t border-[#1A1A1A] pt-8 mt-4 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2.5 text-zinc-700 text-[10px] font-bold tracking-widest order-2 select-none">
            <span className="px-2 py-0.5 border border-zinc-900 rounded bg-[#0A0A0A]">VISA</span>
            <span className="px-2 py-0.5 border border-zinc-900 rounded bg-[#0A0A0A]">MC</span>
            <span className="px-2 py-0.5 border border-zinc-900 rounded bg-[#0A0A0A]">AMEX</span>
            <span className="px-2 py-0.5 border border-zinc-900 rounded bg-[#0A0A0A]">PAYPAL</span>
          </div>
          ...
          <div className="relative flex items-center bg-zinc-950 border border-zinc-900 hover:border-[#FF4C00]/50 rounded-full px-3.5 py-2 text-zinc-400 hover:text-white transition-all duration-200 order-1 md:order-3 shadow-sm select-none">
            <Globe size={14} className="text-[#FF4C00] mr-2 pointer-events-none" />
            <select 
            ...
            <ChevronDown size={11} className="absolute right-3.5 text-zinc-500 pointer-events-none" />
          </div>

          ...
          <div className="flex-1 p-3.5 sm:p-4 overflow-y-auto space-y-3 bg-slate-950/60 scrollbar-thin scrollbar-thumb-slate-800">
            {messages.map((msg) => (
              ...
              >
                ...
                <div
                  className={`max-w-[82%] sm:max-w-[78%] rounded-2xl px-3.5 py-2.5 shadow-sm whitespace-pre-wrap ${
                    msg.sender === 'user'
          ...
          {isOpen ? (
            ...
            <>
              ...
              <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5 sm:h-4 sm:w-4">
                ...
                <span className="relative inline-flex rounded-full h-3.5 w-3.5 sm:h-4 sm:w-4 bg-green-600 border-2 border-slate-900" />
              </span>
            </>
          )}
        </button>

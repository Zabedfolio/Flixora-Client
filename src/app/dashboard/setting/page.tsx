...
const PRESET_AVATARS = [
  {
    id: "spiderman",
    name: "Spider-Man",
    url: "https://i.ibb.co/Cs0Z14TD/857476df6e87.jpg",
  },
  {
    id: "batman",
    name: "Batman",
    url: "https://i.ibb.co/fzQdvy33/c5005c8f408c.jpg",
  },
  {
    id: "hulk",
    name: "Hulk",
    url: "https://i.ibb.co/KjG62St5/28a071b23c43.jpg",
  },
  {
    id: "ironman",
    name: "Iron Man",
    url: "https://i.ibb.co/N6pnL1Vd/c0b33285fed7.jpg",
  },
  {
    id: "captain_america",
    name: "Captain America",
    url: "https://i.ibb.co/9kBq2HrN/99052d2013b0.jpg",
  },
  {
    id: "robot",
    name: "Robot",
    url: "https://i.ibb.co/99BwLZ1f/df4b1e66aac1.png",
  },
  { id: "tom", name: "Tom", url: "https://i.ibb.co/ZRCZZjZY/77a32760a782.png" },
  {
    id: "jerry",
    name: "Jerry",
    url: "https://i.ibb.co/chCxgVC0/e7ba688df62e.png",
  },
  {
    id: "preset_1",
    name: "Vector 1",
    url: "https://i.ibb.co/T94VNG1/feca82718a3f.png",
  },
  {
    id: "preset_2",
    name: "Vector 2",
    url: "https://i.ibb.co/hRfpJsBz/77c8ff018f5a.png",
  },
  {
    id: "preset_3",
    name: "Vector 3",
    url: "https://i.ibb.co/XxyLdGR6/3dc0753b83ec.png",
  },
  {
    id: "preset_4",
    name: "Vector 4",
    url: "https://i.ibb.co/mrkSXMgF/7dedb3686be5.png",
  },
  {
    id: "preset_5",
    name: "Vector 5",
    url: "https://i.ibb.co/LXQNQV9m/652fb8497ee2.png",
  },
  {
    id: "preset_6",
    name: "Vector 6",
    url: "https://i.ibb.co/1Y2xx1kP/51b2fb15a0ee.png",
  },
  {
    id: "preset_7",
    name: "Vector 7",
    url: "https://i.ibb.co/CKKwvPt3/ff71a75a86b2.png",
  },
  {
    id: "preset_8",
    name: "Vector 8",
    url: "https://i.ibb.co/gbHs65wB/23a94dbf6add.png",
  },
  {
    id: "preset_9",
    name: "Vector 9",
    url: "https://i.ibb.co/wr8KLWVX/b36812a8e507.png",
  },
  {
    id: "preset_10",
    name: "Vector 10",
    url: "https://i.ibb.co/Kj6rV2Lf/6d56e0aff7cb.png",
  },
  {
    id: "preset_11",
    name: "Vector 11",
    url: "https://i.ibb.co/xS2Bbnnf/c2ad01014374.png",
  },
  {
    id: "preset_12",
    name: "Vector 12",
    url: "https://i.ibb.co/1tg3pmf5/66bf149bee43.png",
  },
  {
    id: "preset_13",
    name: "Vector 13",
    url: "https://i.ibb.co/6JYZcLwx/78848dc519d3.png",
  },
  {
    id: "preset_14",
    name: "Vector 14",
    url: "https://i.ibb.co/t6rg5Wg/0a79a010554f.png",
  },
  {
    id: "preset_15",
    name: "Vector 15",
    url: "https://i.ibb.co/JjbgKv0Y/5a26e062d00a.png",
  },
  {
    id: "preset_16",
    name: "Vector 16",
    url: "https://i.ibb.co/nNTXmzFc/94d78e061075.png",
  },
  {
    id: "preset_17",
    name: "Vector 17",
    url: "https://i.ibb.co/6Rjr6hnF/b4b11563b172.png",
  },
  {
    id: "preset_18",
    name: "Vector 18",
    url: "https://i.ibb.co/B1kNw0P/d35c729b0b32.png",
  },
  {
    id: "preset_19",
    name: "Vector 19",
    url: "https://i.ibb.co/0VhJB6Jq/81a3061e3614.png",
  },
  {
    id: "preset_20",
    name: "Vector 20",
    url: "https://i.ibb.co/K3tMSb9/3c4645c88c8b.png",
  },
];
...
export default function SettingsPage() {
  ...
  const updateRole = async () => {
    if (
      ...
      selectedRole !== (session.user as any).role
    ) {
      ...
      const fetchProfiles = async () => {
        try {
          const res = await fetch(
            `${API_BASE}/api/profiles?userId=${session.user.id}`,
          );
          if (res.ok) {
  ...
  const handleDeleteAccountConfirm = async () => {
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        toast.error(
          data.message || "Incorrect password. Account deletion unauthorized.",
        );
        setIsDeleteAlertModalOpen(false);
        setIsDeletePasswordModalOpen(true);
      } else {
            ...
            {SUB_TABS.map((tab) => {
              ...
              return (
                ...
                >
                  <Icon
                    size={16}
                    className={isActive ? "text-[#FF4C00]" : "text-zinc-500"}
                  />
                  <span>{tab.label}</span>
                </button>
              );
                    ...
                    <div className="flex items-center gap-4 mt-1">
                      <label className="border border-zinc-700 hover:border-[#FF4C00] text-zinc-300 hover:text-white font-bold text-xs uppercase tracking-wider py-2.5 px-4 rounded-xl transition-all cursor-pointer flex items-center gap-2">
                        {uploadingImage ? (
                          <Loader2
                            size={14}
                            className="animate-spin text-[#FF4C00]"
                          />
                        ) : (
                          <Plus size={14} />
                        )}
                        ...
                        <div className="relative">
                          ...
                          >
                            <div className="flex items-center gap-2.5">
                              <CurrentIcon
                                size={14}
                                className={currentRoleObj.color}
                              />
              ...
              <div className="flex flex-col gap-6 animate-in fade-in duration-200 max-w-xl">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-semibold mt-1 uppercase tracking-wide">
                    Manage primary access emails, passwords, and security
                    options
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between border-b border-[#1A1A1A] pb-6">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                      Secure your account with multi-factor tokens
                    </span>
                  </div>
                  <input
                    type="checkbox"
                ...
                <div className="mt-4 pt-4 border-t border-red-950/20">
                  ...
                  <p className="text-[10px] text-zinc-500 font-semibold leading-relaxed mt-1 uppercase tracking-wide">
                    Permanently purge your Flixora account data
                  </p>
                  <button
                    onClick={() => {
            ...
            {activeSubTab === "notifications" && (
              <div className="flex flex-col gap-6 animate-in fade-in duration-200">
                ...
                <div className="space-y-4 max-w-xl">
                  {[
                    {
                      state: notifyNewEpisodes,
                      setState: setNotifyNewEpisodes,
                      title: "New Episode Alerts",
                      desc: "Get notified when new episodes of your saved shows drop",
                    },
                    {
                      state: notifyRecommend,
                      setState: setNotifyRecommend,
                      title: "Recommendation Emails",
                      desc: "Receive weekly taste recommendations curated by our AI engine",
                    },
                    {
                      state: notifyPromo,
                      setState: setNotifyPromo,
                      title: "Promotional Offers",
                      desc: "Stay updated on plan discounts and early-access campaigns",
                    },
                    {
                      state: notifyAi,
                      setState: setNotifyAi,
                      title: "AI Assistant Tips",
                      desc: "Allow AI conversational hints on mood-playlist recommendations",
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
                      className="flex items-center justify-between border-b border-[#1A1A1A]/40 pb-4"
                    >
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          triggerAutoSaveToast(item.title);
                        }}
                        className="toggle toggle-[#FF4C00] checked:bg-[#FF4C00] checked:border-[#FF4C00]"
                      />
                    </div>
            ...
            {activeSubTab === "playback" && (
              <div className="flex flex-col gap-6 animate-in fade-in duration-200 max-w-lg">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-semibold mt-1 uppercase tracking-wide">
                    Configure screen ratios and default resolutions
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between border-b border-[#1A1A1A]/40 pb-5">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                      Auto-selects optimal stream rates
                    </span>
                  </div>
                  <select
                    value={quality}
                    onChange={(e) => {
                      ...
                      triggerAutoSaveToast("Default Quality");
                    }}
                ...
                <div className="flex items-center justify-between border-b border-[#1A1A1A]/40 pb-5">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                      Automatically start queue titles
                    </span>
                  </div>
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) => {
                      ...
                      triggerAutoSaveToast("Autoplay preference");
                    }}
                    className="toggle toggle-[#FF4C00] checked:bg-[#FF4C00] checked:border-[#FF4C00]"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                      Loads English captions on playback
                    </span>
                  </div>
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) => {
                      ...
                      triggerAutoSaveToast("Subtitle preference");
                    }}
                    className="toggle toggle-[#FF4C00] checked:bg-[#FF4C00] checked:border-[#FF4C00]"
                  />
                </div>
            ...
            {activeSubTab === "privacy" && (
              <div className="flex flex-col gap-6 animate-in fade-in duration-200 max-w-lg">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-semibold mt-1 uppercase tracking-wide">
                    Control your profile visibility and data collection
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b border-[#1A1A1A]/40 pb-4">
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                        Allow friends to view your movie reviews
                      </span>
                    </div>
                    <input
                      type="checkbox"
                      defaultChecked
                      onChange={() =>
                        triggerAutoSaveToast("Privacy feed settings")
                      }
                      className="toggle toggle-[#FF4C00] checked:bg-[#FF4C00] checked:border-[#FF4C00]"
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-0.5">
                      <span className="text-xs font-bold text-white uppercase tracking-wide">
                        Watch History Data Sync
                      </span>
                      <span className="text-[10px] text-zinc-500 font-semibold leading-relaxed">
                        Store continue-watching progress in cloud
                      </span>
                    </div>
                    <input
                      type="checkbox"
                      defaultChecked
                      onChange={() =>
                        triggerAutoSaveToast("Data sync settings")
                      }
                      className="toggle toggle-[#FF4C00] checked:bg-[#FF4C00] checked:border-[#FF4C00]"
                    />
                  </div>
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setPasswordOtpInput(e.target.value.replace(/\D/g, ""))
                    }
                    placeholder="123456"
                    className="w-full bg-[#141414] border border-[#262626] text-center text-white text-lg font-mono font-bold tracking-[8px] rounded-xl px-4 py-3 focus:outline-none focus:border-[#FF4C00]"
                  />
          ...
          <div className="w-full max-w-md bg-[#0E0E0E] border border-red-900/50 rounded-2xl shadow-2xl p-6 flex flex-col gap-5 select-none animate-in zoom-in-95 duration-200">
            ...
            <div className="bg-red-950/15 border border-red-900/30 rounded-xl p-4 text-xs text-zinc-300 leading-relaxed flex flex-col gap-2">
              <p className="font-bold text-white">
                Are you sure you want to permanently delete your Flixora
                account?
              </p>
              <ul className="list-disc pl-4 text-zinc-400 space-y-1 text-[11px]">
                <li>
                  Account info, authentication credentials, and active session
                  will be purged.
                </li>
                <li>
                  User profiles, custom nicknames, and avatar settings will be
                  deleted.
                </li>
                <li>
                  Saved My List items, watch history, and payment history will
                  be deleted.
                </li>
                <li>
                  Custom playlists will be deleted (except pre-created system
                  playlists).
                </li>

        ...
        <div className="flex flex-col gap-2.5 mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mt-0.5 border-b border-[#1A1A1A] pb-5">
            <p className="text-xs md:text-sm text-zinc-500 font-medium max-w-2xl leading-relaxed">
              Your personalized collection of saved movies and shows, synced securely to your account.
            </p>

            <div className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider bg-zinc-950 border border-zinc-900 px-3.5 py-1.5 rounded-lg select-none">
